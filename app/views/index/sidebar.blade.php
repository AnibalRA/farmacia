...
<aside id="sidebar">
    ...
    <div class="side-widgets overflow">
        <!-- Profile Menu -->
        <div class="text-center  m-b-25" id="profile-menu">
            <a href="" data-toggle="dropdown">
              <h5 class="m-0">
                Rene Sanabria
                <span class="fa fa-sort-asc pull-right"></span>
              </h5>
            </a>
            <ul class="dropdown-menu profile-menu">
                <li><a href="" class="text-center">Mi perfil</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                <li><a href="" class="text-center">Configuración</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
                <li><a href="" class="text-center">Cerra sesión</a> <i class="icon left">&#61903;</i><i class="icon right">&#61815;</i></li>
            </ul>
